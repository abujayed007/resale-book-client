    ...
    return (
        <div className='gap-y-5'>
            <div className='text-left shadow-lg p-7'>
                <h1 class="text-xl font-semibold">What are the different ways to manage a state in a React application?</h1>
            ...
            <div className=' text-left p-7 shadow-lg'>
                <h1 class="text-xl font-semibold"> How does prototypical inheritance work?</h1>
            ...
            <div className=' text-left p-7 shadow-lg'>
                <h1 class="text-xl font-semibold">What is a unit test? Why should we write unit tests?</h1>
                <h5 class="font-medium">What is a unit test?</h5>
                ...
                <h5 class="font-medium my-2">Why should we write unit tests?</h5>
                <ul>
            ...
            <div className=' text-left p-7 shadow-lg gap-y-6'>
                <h1 class="text-xl font-semibold">React vs. Angular vs. Vue?</h1>
                <h5 class="font-medium">React</h5>
                ...
                <h5 class="font-medium">Angular</h5>
